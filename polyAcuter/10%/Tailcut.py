"""The program is designed to get obtained data with reads from a certain
 ".fastq" file and rewrite it, having cut poly(A) tails and poly(T) starts. 
The amount of nucleotides to cut can be variated"""

import sys
import math

"""File names and global vulnerables will be used in the program;
...
file_name_data = '/home/aemilius/Work/Tryp/out_10%_uncut1_1.fastq'
file_name_result = '/home/aemilius/Work/Tryp/out_10%_1_tail_T_cut.fastq'
...
def put_read(read):
    ...
    fd_result.write(read.name + "\n")
    fd_result.write(read.seq + "\n")
    fd_result.write(read.plus + "\n")
    fd_result.write(read.qual + "\n")
...
fd_result = open(file_name_result, "wb")
