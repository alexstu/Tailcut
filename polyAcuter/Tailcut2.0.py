...
MIN_TAIL_LENGTH = int(sys.argv[1])		#	minimum length of suffix/prefix YET CAN BE CONSIDERED a tail; integer
CRITIAL_PROCENTAGE = float(sys.argv[2])	#	procent of mistakes in tail YET ACCEPTABLE; [0;1]

file_name_data = sys.argv[3]

file_name_cut = file_name_data + '_cut_' + str(MIN_TAIL_LENGTH) + '_' + str(CRITIAL_PROCENTAGE) + '.fastq'
file_name_uncut = file_name_data + '_uncut_' + str(MIN_TAIL_LENGTH) + '_' + str(CRITIAL_PROCENTAGE) + '.fastq'
